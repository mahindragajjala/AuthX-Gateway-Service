...
const (
	UserService_SendUser_FullMethodName   = "/proto.UserService/SendUser"
	UserService_SignupUser_FullMethodName = "/proto.UserService/SignupUser"
...
type UserServiceClient interface {
	SendUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) SendUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, UserService_SendUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	SendUser(context.Context, *UserRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) SendUser(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserService_SendUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SendUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SendUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SendUser(ctx, req.(*UserRequest))
	}
